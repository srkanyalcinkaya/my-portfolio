...
const AboutMe = () => {
  return (
    <section className="">
      ...
      <div className=" px-4">
        <div className="pt-20 grid grid-cols-1 md:grid-cols-3  mx-auto gap-y-20 gap-x-20">
          {/* Social Buttons */}
          <div className="inline-flex flex-col">
            <div>
              ...
              <p className="text-lg  mt-4 text-gray-300">
                ...
                <a
                  href={`mailto:syalcinkaya895@gmail.com`}
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex flex-row flex-wrap mt-8">
              ...
              />
              {/* <img
                src="https://raw.githubusercontent.com/github/explore/80688e429a7d4ef2fca1e82350fe8e3517d3494d/topics/solidity/solidity.png"
                className="h-20 w-20 mx-4 my-4"
              /> */}
              <img
